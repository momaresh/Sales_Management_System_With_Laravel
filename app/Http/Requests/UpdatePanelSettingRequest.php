...
class UpdatePanelSettingRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'delegate_parent_account' => 'required',
            'employee_parent_account' => 'required',
            'treasury_parent_account' => 'required',
            'customer_first_code' => 'required',
            'supplier_first_code' => 'required',
            'delegate_first_code' => 'required',
            'employee_first_code' => 'required',
            'phone' => 'required',
            'address' => 'required',
