        ...
        @csrf
            <div class="row">
                ...
                <div class="col-md-6 relatied_parent_counter "  @if(old('unit_id')=='' ) style="display: none;" @endif>
                    ...
                    <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="price_per_one_in_master_unit" id="price_per_one_in_master_unit" class="form-control"  value="{{ old('price_per_one_in_master_unit', $data->price_per_one_in_master_unit) }}" placeholder="ادخل السعر " >
                ...
                <div class="col-md-6 relatied_parent_counter "  @if(old('unit_id')=='' ) style="display: none;" @endif>
                    <div class="form-group">
                        ...
                        <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="price_per_half_group_in_master_unit" id="price_per_half_group_in_master_unit" class="form-control"  value="{{ old('price_per_half_group_in_master_unit', $data->price_per_half_group_in_master_unit) }}" placeholder="ادخل السعر " >
                ...
                <div class="col-md-6 relatied_parent_counter "  @if(old('unit_id')=='' ) style="display: none;" @endif>
                    <div class="form-group">
                        ...
                        <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="price_per_group_in_master_unit" id="price_per_group_in_master_unit" class="form-control"  value="{{ old('price_per_group_in_master_unit', $data->price_per_group_in_master_unit) }}" placeholder="ادخل السعر " >
                ...
                <div class="col-md-6 relatied_parent_counter "  @if(old('unit_id')=='' ) style="display: none;" @endif>
                    <div class="form-group">
                        ...
                        <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="cost_price_in_master" id="cost_price_in_master" class="form-control"  value="{{ old('cost_price_in_master', $data->cost_price_in_master) }}" placeholder="ادخل السعر " >
                ...
                <div class="col-md-6 relatied_retial_counter " @if(old('retail_unit_id')=="" ) style="display: none;" @endif>
                    <div class="form-group">
                        ...
                        <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="price_per_one_in_retail_unit" id="price_per_one_in_retail_unit" class="form-control"  value="{{ old('price_per_one_in_retail_unit', $data->price_per_one_in_retail_unit) }}" placeholder="ادخل السعر " >
                ...
                <div class="col-md-6 relatied_retial_counter " @if(old('retail_unit_id')=="") style="display: none;" @endif>
                    <div class="form-group">
                        ...
                        <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="price_per_half_group_in_retail_unit" id="price_per_half_group_in_retail_unit" class="form-control"  value="{{ old('price_per_half_group_in_retail_unit', $data->price_per_half_group_in_retail_unit) }}" placeholder="ادخل السعر " >
                ...
                <div class="col-md-6 relatied_retial_counter " @if(old('retail_unit_id')=="" ) style="display: none;" @endif>
                    <div class="form-group">
                        ...
                        <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="price_per_group_in_retail_unit" id="price_per_group_in_retail_unit" class="form-control"  value="{{ old('price_per_group_in_retail_unit', $data->price_per_group_in_retail_unit) }}" placeholder="ادخل السعر " >
                ...
                <div class="col-md-6 relatied_retial_counter " @if(old('retail_unit_id')=="" ) style="display: none;" @endif>
                    <div class="form-group">
                        ...
                        <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="cost_price_in_retail" id="cost_price_in_retail" class="form-control"  value="{{ old('cost_price_in_retail', $data->cost_price_in_retail) }}" placeholder="ادخل السعر " >
