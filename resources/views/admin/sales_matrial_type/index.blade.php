...
<div>
    <a href="{{ route('admin.sales_matrial_type.create') }}" style="background-color: #007bff; font-size: 20px; margin: 10px auto; width: fit-content; display: block; color: white" class="btn">
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h3 class="text-center" style="font-weight: 600; font-size: 20px;">بيانات فئات الفواتير</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
...
@section('contentheaderlink')
    <a href="{{ route('admin.sales_matrial_type.index') }}">فئات الفواتير</a>
@endsection
        ...
        $(function() {
            $(document).on('input', '#ajax_search', function() {
                ...
                jQuery.ajax({
                    ...
                    url:"{{ route('admin.sales_matrial_type.ajax_search') }}",
