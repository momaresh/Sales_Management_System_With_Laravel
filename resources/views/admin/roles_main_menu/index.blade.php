...
<div>
    <a href="{{ route('admin.roles_main_menu.create') }}" style="background-color: #007bff; font-size: 15px; margin: 10px auto; width: fit-content; display: block; color: white" class="btn">
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h3 class="text-center" style="font-weight: 600; font-size: 20px;">بيانات القوائم الرئيسية للصلاحيات</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                ...
                <table id="example2" class="table table-bordered table-hover">
                    ...
                    @if (!@empty($data[0]))
                        ...
                        @foreach ($data as $datum)
                            <tr>
                                <td>
                                    <a href="{{ route('admin.roles_main_menu.edit', $datum->id) }}" style="color: rgb(149, 35, 35); font-size: 25px;">
                                ...
                                <td>
                                    <a href="{{ route('admin.roles_main_menu.delete', $datum->id) }}" class="are_you_sure" style="color: rgb(149, 35, 35); font-size: 25px;">
        ...
        $(function() {
            ...
            function make_search() {
                ...
                jQuery.ajax({
                    ...
                    url:"{{ route('admin.roles_main_menu.ajax_search') }}",
