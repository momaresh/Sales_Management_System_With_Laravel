...
<html>
   <head>
        ...
        <title>طباعة فاتورة مرتجع مبيعات بالفاتورة الاصل</title>
        ...
        <table style="width: 30%;float: right;  margin-right: 5px;" dir="rtl">
            <tr>
                <td style="text-align: center;padding: 5px;">  <span style=" display: inline-block;
                    ...
                    border: 1px solid black; border-radius: 15px;font-weight: bold;">فاتورة مرتجع مبيعات بالفاتورة الاصل</span>
                </td>
            </tr>
            <tr>
