...
<div>
    <a href="{{ route('admin.customers.create') }}" style="background-color: #007bff; font-size: 20px; margin: 10px auto; width: fit-content; display: block; color: white" class="btn">
                    ...
                    @if (!@empty($data[0]))
                        ...
                        @foreach ($data as $datum)
                            <tr>
                                ...
                                <td>{{ $datum['customer_balance'] }}</td>
                                <td>{{ $datum['customer_start_balance'] }}</td>
                                <td>
    ...
    $(function() {
        ...
        function make_search() {
            ...
            jQuery.ajax({
                ...
                url:"{{ route('admin.customers.ajax_search') }}",
