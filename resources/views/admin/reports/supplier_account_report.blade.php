    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h3 class="text-center" style="font-weight: 600; font-size: 20px;">تقارير الموردين</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <form action="{{ route('admin.reports.supplier_account_report') }}" method="post" target="_blank">
                @csrf
                <div class="row">
                    <div class="col-md-4">
...
@section('contentheaderlink')
    <a href="{{ route('admin.reports.supplier_account_report') }}">تقرير حساب مورد</a>
@endsection
