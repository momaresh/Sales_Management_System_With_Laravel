...
<div>
    @if (check_control_menu_role('الحسابات', 'المناديب' , 'اضافة') == true)
        <a href="{{ route('admin.delegates.create') }}" style="background-color: #007bff; font-size: 15px; margin: 10px auto; width: fit-content; display: block; color: white" class="btn">
