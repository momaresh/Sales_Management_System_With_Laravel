...
<div>
    <a href="{{ route('admin.suppliers.create') }}" style="background-color: #007bff; font-size: 20px; margin: 10px auto; width: fit-content; display: block; color: white" class="btn">
    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="mb-3 row">
                <div class="col-md-6">
                    <label class="control-label" for="cus_code">بحث برقم المورد</label>
    ...
    $(function() {
        ...
        function make_search() {
            ...
            jQuery.ajax({
                ...
                url:"{{ route('admin.suppliers.ajax_search') }}",
        ...
        $(document).on('click', '.details_button', function(e) {
            ...
            jQuery.ajax({
                // first argument is the where the from route to
                url:"{{ route('admin.suppliers.details') }}",
                // second argument is sending type of the form
                type:'post',
                // third argument is the type of the returned data from the model
                datatype:'html',
