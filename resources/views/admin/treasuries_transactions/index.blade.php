...
@if (check_control_menu_role('الحسابات', 'شاشة تحصيل النقدية' , 'اضافة') == true)
    @if (!@empty($check_has_shift))
        <div class="card">
            ...
            <h3 class="card-title"> اضافة تحصيل جديد</h3>
            </div>
        <!-- /.card-header -->
            <div class="card-body">
...
@if (check_control_menu_role('الحسابات', 'شاشة تحصيل النقدية' , 'عرض') == true)
    <div class="row">
        <div class="col-12">
        <div class="card">
            <div class="card-header">
...
@section('contentheaderlink')
    <a href="{{ route('admin.treasuries_transactions.index') }}">شاشة التحصيل</a>
@endsection
    ...
    <script>
        $(function() {
            $(document).on('change', '#account_number', function() {
                ...
                if (account_number != '') {
                    jQuery.ajax({
                        url: "{{ route('admin.treasuries_transactions.get_status') }}",
                        type: 'post',
                        dataType: 'html',
                        cache: false,
                        data: {
            ...
            function make_search() {
                ...
                jQuery.ajax({
                    ...
                    url:"{{ route('admin.treasuries_transactions.ajax_search') }}",
