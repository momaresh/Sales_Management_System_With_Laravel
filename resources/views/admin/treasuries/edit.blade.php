...
<div class="card">
    <div class="card-header">
      <h3 class="card-title">تعديل خزينة</h3>
    </div>
    <!-- /.card-header -->
    <!-- form start -->
    <form class="form-horizontal" action="{{ route('admin.treasuries.update', $data->id) }}" method="post">
        @csrf
        <div class="card-body">
            <div class="form-group row">
                <label for="inputEmail3" class="col-sm-2 control-label">اسم الخزينة</label>
                <div class="col-sm-10">
                    <input type="text" name="name" class="form-control" value="{{ old('name', $data->name) }}" placeholder="اسم الخزينة">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select name="master" class="form-control">
                        <option @if (old('master', $data->master) == 0) selected @endif value="0">لا</option>
                        <option @if (old('master', $data->master) == 1) selected @endif value="1">نعم</option>
                    </select>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="number" value="{{ old('last_exchange_arrive', $data->last_exchange_arrive) }}" name="last_exchange_arrive" class="form-control" placeholder="اخر ايصال صرف">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="number" value="{{ old('last_collection_arrive', $data->last_collection_arrive) }}" name="last_collection_arrive" class="form-control" placeholder="اخر ايصال تحصيل">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="number" value="{{ old('last_unpaid_arrive', $data->last_unpaid_arrive) }}" name="last_unpaid_arrive" class="form-control" placeholder="اخر ايصال آجل">
