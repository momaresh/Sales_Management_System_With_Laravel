                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>الرصيد المتاح بالخزنة</label>
                                    <input type="text" name="money_in_treasury" id="money" readonly value="{{ $check_has_shift['money_in_treasury'] }}" class="form-control">
                            </div>
                        </div>
...
@if (check_control_menu_role('الحسابات', 'شاشة صرف النقدية' , 'عرض') == true)
    <div class="row">
        <div class="col-12">
        <div class="card">
            <div class="card-header">
