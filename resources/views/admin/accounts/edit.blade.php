                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="account_type" id="account_type" class="form-control select2">
                                ...
                                @foreach ($account_types as $info )
                                    <option data-is_internal="{{ $info->related_internal_accounts }}" {{  old('account_types', $data['account_type']) == $info->id  ? 'selected' : '' }}  value="{{ $info->id }}">{{ $info->name }}</option>
                                @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <select name="parent_account_number" id="parent_account_number" class="form-control select2">
                                ...
                                @foreach ($parent_accounts as $info )
                                    <option @if (old('parent_account_number', $data['parent_account_number']) == $info->account_number) selected @endif value="{{ $info->account_number }}"> {{ $info->notes }} </option>
                                @endforeach
                    ...
                    <div class="col-md-12">
                        <div class="form-group text-center">
                            <button id="do_add_item_card" type="submit" class="btn btn-primary btn-sm">تعديل</button>
