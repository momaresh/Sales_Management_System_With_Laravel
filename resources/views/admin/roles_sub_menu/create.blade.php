...
<div class="card">
    <div class="card-header">
      <h3 class="card-title">اضافة  قائمة فرعية للصلاحيات</h3>
    </div>
    <!-- /.card-header -->
    <!-- form start -->
    <form class="form-horizontal" action="{{ route('admin.roles_sub_menu.store') }}" method="post">
        @csrf
        <div class="card-body">
